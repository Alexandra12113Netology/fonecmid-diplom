...
Доп. параметры в зависимости от выбора пользователя по сценарию: Тест ОбслуживаниеКлиента запускать от имени пользователей - /N"СоколовВВ (Менеджер)" Тест ЗакрытиеОбслуживанийСпециалист запускать от имени пользователей - /N"ПетровВС(Специалист)" и /N"НовиковДЛ(Специалист)" Тест МассовоеСозданиеАктов запускать от имени пользователя /N"ПоляковаИА(Бухгалтер)" Тест ОтчетАнализВыставленныхАктов запускать от имени пользователя /N"ПоляковаИА(Бухгалтер)"
