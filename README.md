...
выбор Клиента тестирования Имя - DiplomУправлениеITФирмой 
Тип клиента - Тонкий 
...
Тест ОбслуживаниеКлиента запускать от имени пользователей - /N"СоколовВВ (Менеджер)"
Тест ЗакрытиеОбслуживанийСпециалист запускать от имени пользователей - /N"ПетровВС(Специалист)" и /N"НовиковДЛ(Специалист)"
Тест МассовоеСозданиеАктов запускать от имени пользователя /N"ПоляковаИА(Бухгалтер)"
Тест ОтчетАнализВыставленныхАктов запускать от имени пользователя /N"ПоляковаИА(Бухгалтер)"
